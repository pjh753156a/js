...
/*
    ...
    - 반드시 피연산자는 반복 가능한 객체 (배열, 객체, 문자열등....) 이어야 함
*/
...
let newNumbers3 = [ ...numbers,...numbers2 ];
...
newKing = {...king, name: '이단', birth: '1335.11.03' };
console.log(newKing);
